...
while 1:
    ...
    dxl1_comm_result, dxl1_error = packetHandler.write4ByteTxRx(
    ...
    dxl2_comm_result, dxl2_error = packetHandler.write4ByteTxRx(
    ...
    while 1:
        dxl1_present_position, dxl1_comm_result, dxl1_error = packetHandler.read4ByteTxRx(
        ...
        dxl2_present_position, dxl2_comm_result, dxl2_error = packetHandler.read4ByteTxRx(
        ...
        print("[ID:%03d] GoalPos:%03d  PresPos:%03d" %
              (DXL2_ID, dxl_goal_position[index], dxl1_present_position))
